...
const ManagerRequestPasswordReset: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      await api.post('/manager/password-reset', { email });
          ...
          <div className="flex flex-col m-4 md:mx-20 p-4 md:px-24 py-7 md:py-12 w-full max-w-5xl">
            <div className="text-start px-8 mb-8">
              <h2 className="text-4xl font-bold pb-2">
                Recuperar <span className="text-orange-600">Senha do Gestor</span>
              </h2>
...
export default ManagerRequestPasswordReset;

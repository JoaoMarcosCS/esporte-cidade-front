...
const FooterMobile: React.FC<FooterMobileProps> = ({ links = [] }) => {
  ...
  return (
    <footer className="fixed bottom-0 w-full p-4 bg-[#F4F6FF] border-t border-gray-200 shadow-inner flex justify-around py-3 md:hidden gap-4">
